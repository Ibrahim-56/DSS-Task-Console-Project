...
if (isset($_SESSION['role']) && isset($_SESSION['id']) && $_SESSION['role'] == "admin") {
    ...
    if (isset($_GET['due_date']) &&  $_GET['due_date'] == "Due Today") {
    	$text = "Due Today";
      $tasks = get_all_tasks_due_today(conn: $conn);
      $num_task = count_tasks_due_today(conn: $conn);

    }else if (isset($_GET['due_date']) &&  $_GET['due_date'] == "Overdue") {
    	$text = "Overdue";
      $tasks = get_all_tasks_overdue(conn: $conn);
      $num_task = count_tasks_overdue(conn: $conn);

    }else if (isset($_GET['due_date']) &&  $_GET['due_date'] == "No Deadline") {
    	$text = "No Deadline";
      $tasks = get_all_tasks_NoDeadline(conn: $conn);
      $num_task = count_tasks_NoDeadline(conn: $conn);

    }else{
    	 $tasks = get_all_tasks(conn: $conn);
